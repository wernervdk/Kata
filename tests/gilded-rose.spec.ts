...
describe("Gilded Rose", () => {
  ...
  it("should create baseline test for Aged Brie", () => {
  ...
  it("should create baseline test for Sulfuras", () => {
    const items = [
  ...
  it("should create baseline test for Backstage passes", () => {
    const items = [
  ...
  it("should create baseline test for the other items", () => {
    const items = [
  ...
  it("should create baseline test for Conjured", () => {
